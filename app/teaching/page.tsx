...
const groups: Array<[string, string[]]>=[
  ...
  ['本科毕业设计（按毕业届）',['王铭澜（2024 届）','陈纪潼（2024 届）','周洁（2024 届，重庆大学）','张昱烨（2024 届，郑州大学）','陈豪鑫（2024 届，河北工业大学）','胡子鸣（2024 届）','丁光伟（2024 届）','吴汉威（2023 届）','张家烁（2023 届，东北大学）','雷渝越（2023 届）']],
  ['学业导师（按入学年级）',['李泓锦（2024 级）','汤之洋（2024 级）','王文杰（2023 级）','王鹏宵（2023 级）','陈一鸣（2023 级）','陆岳（2023 级）','许戈（2023 级）','原帅（2023 级）','曹弘睿（2022 级）','谢东皓（2022 级）','邓远韬（2022 级）','叶润植（2022 级）','胡楷（2022 级）']],
  ['优本计划（按入学年级）',['吴汉威（2019 级）','葛思凯（2019 级）']],
  ['强基计划（按入学年级）',['宋郅博（2021 级）']],
  ['班主任',['信息与计算科学 2301 班']],
];
