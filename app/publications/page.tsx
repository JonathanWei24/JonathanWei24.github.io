...
export default function PublicationsPage(){return <main>
  <section className="page-hero shell"><p className="eyebrow">PUBLICATIONS & BOOK</p><h1>论文与专著</h1><div className="page-actions"><a className="button primary" href={scholarProfile} target="_blank" rel="noreferrer">Google Scholar <ExternalLink size={16}/></a></div></section>
